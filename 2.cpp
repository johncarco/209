...
int main(){
    ...
    cout<<"\nTotal Premium Tickets Availed: "<<TotalPremium<<endl;
    cout<<"\nTotal Box Tickets Availed: "<<TotalBox<<endl;
    cout<<"\nTotal Sideline Tickets Availed: "<<TotalSideline<<endl;
    cout<<"\nTotal General Ad Tickets Availed: "<<TotalGenAd<<endl;
    cout<<"\nTotal Sales: "<<Total<<endl;
    cout<<"\nTotal Tickets Sold: "<<TotalTix<<endl;
